...
const Main = () => {
    ...
    const addShape = (value: string) => {
        ...
        let shapeData: ShapeDataValidation = {
            type: 'RECT', shape_id: '', top: 0, left: 0, stroke: '', fill: 'transparent', roomId
        };
        ...
        if (value === 'RECT') {
            shapeData = { type: 'RECT', shape_id: `RECT-${random}`, width: 100, height: 100, top: 100, left: 200, fill: "transparent", stroke: "#d3d3d3", roomId }
        } else if (value === 'CIRCLE') {
            shapeData = { type: 'CIRCLE', shape_id: `CIRCLE-${random}`, radius: 100, top: 100, left: 200, fill: "transparent", stroke: "#d3d3d3", roomId }
        } else if (value === 'RHOMBUS') {
            shapeData = { type: 'RECT', shape_id: `RHOMBUS-${random}`, width: 100, height: 100, top: 100, left: 200, angle: 45, fill: "transparent", stroke: "#d3d3d3", roomId }
        }
        if (!shapeData) return
        drawShape(shapeData)
